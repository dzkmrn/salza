...
<body>
    <nav class="navbar nav sticky-top navbar-expand-lg navbar-light" style="background-color: #f2f2f2;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="indexLog.php">Beranda <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="zakat/index.html">Zakat</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="#">Keluar</a>
                </li>
            </ul>
            <?php
            $sel = "SELECT * FROM tb_user order by id_user desc";
            $query =  mysqli_query($koneksi, $sel);
            $result = mysqli_fetch_assoc($query);
            echo "<p style='margin-left:70%;font-size4pt;margin-top:4px;background-color:#00D28E;padding:7px;border-radius: 10px;'>" . $result['fullname'] . "<br>". $result['email'] . "</p>";
            ?>
        </div>
    </nav><br>
    ...
    <div class="card-body">
        ...
        <a class="button-zakat" href="zakat/index.html"><button type="button" class="btn btn-success" style="border: 1pt black;">Salurkan Zakatmu!</button></a>
        <br><br>
    </div>
    <br><br><br><br><br><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php"><button type="button" class="btn btn" style="background-color: #00D28E;color: white;">Keluar</button></a>
                </div>
            </div>
        </div>
    </div>
